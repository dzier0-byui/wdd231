...
function populateClasses(filteredCourses) {
    const classGrid = document.getElementById('class-options');
    classGrid.innerHTML = '';

    filteredCourses.forEach(course => {
        const courseItem = document.createElement('p');
        courseItem.textContent = `${course.subject} ${course.number}`;
        courseItem.className = course.completed ? 'completed' : 'not-completed';
        classGrid.appendChild(courseItem);
    });
